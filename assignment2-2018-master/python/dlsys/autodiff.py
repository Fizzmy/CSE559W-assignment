...
class AddByConstOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_elemwise_add_by_const(input_shapes[0],node.const_attr,tgt,tgt_host,"elem_add_const")
...
class BroadcastToOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_broadcast_to(input_shapes[0],input_shapes[1],tgt,tgt_host,"broadcast_to")
...
class SoftmaxCrossEntropyOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_matrix_softmax_cross_entropy(input_shapes[0],tgt,tgt_host,"matrix_softmax_cross_entropy")
...
class SoftmaxOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_matrix_softmax(input_shapes[0],tgt,tgt_host,"matrix_softmax")
...
class ReluOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_relu(input_shapes[0],tgt,tgt_host,func_name="relu")
...
class Executor(object):
    ...
    def infer_shape(self, feed_shapes):
        ...
        for node in self.topo_order:
            if node in feed_shapes:
                continue
            shapes = [get_node_shape(n) for n in node.inputs]
    ...
    def memory_plan(self, feed_shapes):
        ...
        for node in self.topo_order:
            if node in feed_shapes:
                continue
            shapes = get_node_shape(node)
            self.node_to_arr_map[node]=tvm.runtime.ndarray.empty(shapes)
    ...
    def compile_funcs(self, feed_shapes):
        ...
        for node in self.topo_order:
            if node in feed_shapes:
                continue
            shapes = [get_node_shape(n) for n in node.inputs]
            self.node_to_compiled_func[node]=node.op.compiled_func(node,shapes,self.tgt,self.tgt_host)
